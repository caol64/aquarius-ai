...
struct KnowledgeSettingGroup: View {
    ...
    var body: some View {
        Group {
            exclusiveExpandGroup(id: "knowledges", expandId: $expandId, noNeedExpand: knowledge == nil ? true: false) {
